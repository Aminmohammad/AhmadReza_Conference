...
function et_Power_2_for_RHO_Callback(~, eventdata, handles)
...
function pb_start_Callback(hObject, eventdata, handles)
    ...
    % Making a New 'Temp-Results-Folder' Address
        % Extraction of the Address
            ...
            temp_Current_path = current_path(:,1:indices(:,end));
            temp_Results_Folder_Address = sprintf('%s%s',temp_Current_path , 'Temp_Results_Folder');
        
        % Deleting 'Results_Folder' if it Exists            
            if ( exist( temp_Results_Folder_Address, 'dir')~=0 )
                rmdir( temp_Results_Folder_Address, 's' )
            end
            
        % Making the 'Results_Folder'
            mkdir( temp_Results_Folder_Address )         
        
    % Adding the Essential Folders       
        AddPath( 'Functions_Folder' );
        AddPath( 'Ga_Folder' );
        AddPath( temp_Results_Folder_Address );
    % Radio Buttons
    ...
    % Edit Texts   
        ...
        % RHO Section        
            % Random Part
                ...
                et_Number_of_Iterations = str2double ( get ( et_Number_of_Iterations_hdl, 'String') )
...
%                                                                                                                                                     results_Folder_path )                           % The Address of Where data Will be Saved.
%                                                                             
%                                                                             
    ...
    [ranked_all_Chromosomes_of_all_Iterations all_Chromosomes_of_all_Iterations Bests_of_all_Iterations Global_Best] = Genetic_Algorithm_Manager (  [], ...                              % A Maxtrix or '' :  Each Column has the results of a Test for All Variables      
                                                                                                                                                    ...
                                                                                                                                                    ranking_Policy, ...                             % 'Descend' or 'Ascend'   : for 'Descend' the 'Global Best' 'increases'
                                                                                                                                                    ...                                             %             : for 'Ascend'  the 'Global Best' 'descreases'
                                                                                                                                                    temp_Results_Folder_Address )                           % The Address of Where data Will be Saved.                                         
end_Time = toc;
